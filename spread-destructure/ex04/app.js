...
console.warn(
  `In fisierul app.js Ben ar trebui sa aiba 29 de ani,
...
console.warn(
  `Folosind noul obiect fullPerson2, creeaza un obiect numit
   fullPerson3 cu numele de familie al lui Ben,  si numele Carl, care sa aiba 24 de ani.`,
);
